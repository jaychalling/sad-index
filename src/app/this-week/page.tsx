...
import { currentWeekData, topTracksThisWeek } from '@/data/bsi-data'
...
const sortedTracks = [...topTracksThisWeek].sort((a, b) => b.valence - a.valence)
...
// Stats
const allValences = topTracksThisWeek.map((t) => t.valence)
      ...
      <main className="flex-1 max-w-6xl mx-auto px-4 py-10 w-full">
              ...
              {topTracksThisWeek.map((track, i) => {
                ...
                return (
                  ...
                  >
                        ...
                        <div className="w-16 md:w-24 h-3 bg-navy/10 rounded-full overflow-hidden border border-navy/20">
                          <div
                            ...
                            style={{
                              ...
                              backgroundColor: getBarColor(track.valence),
                            }}
                          />
                        </div>
                    ...
                    <td className="py-3 px-2">
                      <span
                        className="inline-block px-2.5 py-1 text-xs font-bold rounded-md border-2 border-navy"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div className="card-brutal text-center p-6">
            ...
            <p className="text-3xl font-bold text-teal" style={{ fontFamily: 'var(--font-poppins)' }}>
              {avgValence.toFixed(3)}
            </p>
          </div>
          <div className="card-brutal text-center p-6">
            <p className="text-sm font-semibold text-navy/50 uppercase tracking-wider mb-2">Median Valence</p>
            <p className="text-3xl font-bold text-teal" style={{ fontFamily: 'var(--font-poppins)' }}>
              {medianValence.toFixed(3)}
            </p>
          </div>
          <div className="card-brutal text-center p-6">
            ...
            <p className="text-sm text-navy/50 mt-1">{mostCommonMood[1]} of 20 tracks</p>
          </div>
        </div>
      </main>
